(() => {
  ...
  async function init(){await wait();upgradeTabs();upgradeHome();upgradeTransactions();upgradeCalendar();upgradeAssets();upgradeSettings();upgradeQuickSheet();document.body.dataset.designVersion='0.8.3'}

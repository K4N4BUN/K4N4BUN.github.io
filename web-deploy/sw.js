"use strict";
const CACHE_NAME="zandaka-yohou-v0-8-0-r2";
const APP_SHELL=[
  "./","./index.html","./manifest.json","./version.json",
  "./features.css","./cloud.css","./cloud-config.js","./cloud.js","./billing.css","./billing-config.js","./legal.css","./design-v080.css","./design-v080.js",
